...
<div class="d-flex" id="wrapper ">
        ...
        <div class="bg" id="sidebar-wrapper" style="witdh:100%;">
           ...
           <li class="nav-item w-100 " style="justify-content: space-between;">
               ...
               <a href="dashboard.php" class="nav-link text-light pl-4 text-dark">
    ...
    <nav class="navbar navbar-expand d-flex justify-content-between flex-column " id="sidebar">
        <a href="#" class="navbar-brand text-light mt-5">
          
            <div class=" border-start border-3 border-primary  fw-bold fs-4  text-dark ">E-classe</div>
   
        </a>
        <div class="admin mb-5" style="text-align: center;">
        <img src="images/profile.jpg" alt="" width="200PX" class="img-fluid rounded-circle my-4 p-1 d-none
        d-md-block ">
            <h5>Admin name</h5>
            <span class=" fs-6 text-info" >Admin</span>              
        </div>
        ...
        <ul class="navbar-nav d-flex flex-column mt-5 mb-5 text-decoration-none">
           ...
           <li class="nav-item w-100 " style="justify-content: space-between;">
            ...
            <div class="logout">
                <a href="index.html" class="list-group-item bg-transparent mt-5 "> 
                    Logout  <img src="images/ic-log-out.svg"> 
                </a>
            </div>    
        </nav>  
-->
